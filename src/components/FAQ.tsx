...
// Q2: Info content - defined outside FAQ to avoid recreating on each render
const InfoContent = () => (
  <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
    <Paper sx={{ p: 2 }}>
    ...
    <Alert severity="info">
      <strong>Note:</strong> This tool analyses your organisation using the GitHub API. Ensure your
      Personal Access Token has the correct permissions. Large organisations may take several
